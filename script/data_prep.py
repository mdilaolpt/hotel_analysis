...
hotel_df['ADR'] = hotel_df['RM_REV_AMT_LOC'] / hotel_df['RM_NTS']                              #average daily rate (revenue / number of room sold)
hotel_df['REV_PAR'] = hotel_df['RM_REV_AMT_LOC'] / hotel_df['RMS_AVAIL']                       #revenue per available room (revenue / total rooms available)
...
hotel_df.to_csv('data/hotel_df.csv', index=False)
